...
from mongo_status.views import DaySummariesView, CompleteGraphsView, ContributorView, DaySummariesYearView, DaySummariesMonthView
...
urlpatterns = patterns(
    ...
    url(r'^day_summaries/(?P<year>\d{4})/$', DaySummariesYearView.as_view(), name='day_summaries_year'),
    url(r'^day_summaries/(?P<year>\d{4})/(?P<month>\d{1,2})/$', DaySummariesMonthView.as_view(), name='day_summaries_month'),
